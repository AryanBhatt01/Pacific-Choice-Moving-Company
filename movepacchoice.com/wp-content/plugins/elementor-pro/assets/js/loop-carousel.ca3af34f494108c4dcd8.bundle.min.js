            ...
            class LoopCarousel extends i.default {
                ...
                getSwiperSettings() {
                    ...
                    return "yes" === t.arrows && (e.navigation = {
                        prevEl: s ? ".elementor-swiper-button-next" : ".elementor-swiper-button-prev",
                        nextEl: s ? ".elementor-swiper-button-prev" : ".elementor-swiper-button-next"
            ...
            class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
                ...
                getSwiperSettings() {
                    ...
                    Object.keys(n).reverse().forEach((t => {
                        ...
                        }, e.image_spacing_custom && (r.breakpoints[n[t].value].spaceBetween = this.getSpaceBetween(t)), a = +e["slides_to_show_" + t] || s
                    })), "yes" === e.autoplay && (r.autoplay = {
                        delay: e.autoplay_speed,
                        disableOnInteraction: "yes" === e.pause_on_interaction
                    }), s ? (r.effect = e.effect, "fade" === e.effect && (r.fadeEffect = {
                        crossFade: !0
                    })) : r.slidesPerGroup = +e.slides_to_scroll || 1, e.image_spacing_custom && (r.spaceBetween = this.getSpaceBetween());
                    const o = "arrows" === e.navigation || "both" === e.navigation,
                        l = "dots" === e.navigation || "both" === e.navigation;
                    return o && (r.navigation = {
