                ...
                const u = function createHandleElement(e, t) {
                    ...
                    const a = createElement({
                        ...
                        children: [createElement({
                            ...
                            children: [document.createTextNode(l === t ? o("Edit %s", "elementor-pro").replace("%s", n) : o("Save %s", "elementor-pro").replace("%s", n))]
                        })]
                    });
                    return a.addEventListener("click", s), a
                }({
                    title: a,
        ...
        6685: (e, t, n) => {
            ...
            class Loop extends s.default {
                ...
                attachEditDocumentHandle() {
                    ...
                    s && (this.isFirstEdit() ? this.$element.find(".elementor-swiper-button").remove() : (0, l.default)({
                        element: s,
